...
MODEL_BASE='Person' #CHANGE
ROOT_DIR = "D:/Jupyter/MSDS/MaskRCNN/" + MODEL_BASE
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        #annotations1 = json.load(open('D:/Nagendra/Jupyter/MaskRCNN/Aarohi2/dataset/train/via_project.json'))
